<?php
  $translation = array(
		  ...
		  'No set up email account.' => 'Kein E-Mail Account eingerichtet.',
			"No set up twitter account." => "Du hast noch keinen Twitter Account auf dem Gerät eingerichtet. Dieser ist für das Sharing notwendig. Bitte gehe zu Einstellungen -> Twitter und gib Deine Anmeldedaten ein.",
			'Copy link' => 'Link kopieren',
			'Open in Safari' => 'In Browser öffnen',
      ...
      'Onboarding_FirstText'=>"Über das Hauptmenü gelangen Sie zu den Push-Einstellungen.\n\nBitte klicken Sie auf",
      'Onboarding_LastText'=>'und wählen Sie dort die Themen, zu denen Sie Informationen per Push erhalten möchten.',
      'filter'=>'Filter',
      'search'=>'Suche',
      'results'=>'Alle Ergebnisse:',
      'Rate_App'=>'App bewerten',
      'Rate_App_Text'=> 'Ihnen gefällt diese App? Dann freuen wir uns über eine positive Bewertung im App Store. Vielen Dank für Ihre Unterstützung.',
      'Rate_App_Yes'=>'Jetzt bewerten',
      'Rate_App_No'=>'Nein, danke',
      'Rate_App_Later'=>'Später erinnern',
      'Search_NoResultViewTitle'=>'Keine Suchergebnisse gefunden.',
      'Search_InputPlaceholder'=>'Suchen...',
      'No Events'=>'Keine Veranstaltungen',
      'sendmessage_errormessage'=>'Ihr Gerät hat keine App zum Versenden von EMails installiert.',
      'sharing_errormessage'=>'Ihr Gerät hat keine App zum Teilen des Inhalts installiert.',
      'PDF_Download_Alert_Override_File'=> 'Möchten Sie die vorhandene Datei "#TITLE#" wirklich ersetzen?',
      'PDF_Download_Alert_Override_File_yes'=> 'Datei ersetzen',
      'PDF_Download_Alert_Override_File_cancel'=> 'Abbrechen',
      'PDF_Download_Alert_downloading'=> 'Wird heruntergeladen...',
      'PDF_Download_Alert_Install_PDFViewer_button'=> 'OK',
      'PDF_Download_Alert_Install_PDFViewer'=> 'Bitte installieren Sie einen PDF Viewer, um diese Datei zu öffnen.',
      'PDF_Download_Alert__downloading_Error'=> 'Es ist ein Fehler beim Download aufgetreten. Bitte versuchen Sie es später erneut.'
