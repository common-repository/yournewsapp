	...
	<div id="menu-settings-column" class="metabox-holder">
		...
		<div class="accordion-container" id="side-sortables">
                    ...
                    foreach ($post_types as $post_type) {
                        if (!in_array($post_type, array( 'attachment', 'revision', 'nav_menu_item' ))) {
                            ...
                            $temp .=  '<input type="hidden" value="'.$post_type.'" name="type-menu-item-'.$post_type.$menu_id.'" id="type-menu-item-'.$post_type.$menu_id.'" >';
                                                        ...
                                                        $temp .=  '<input type="hidden" value="html" name="link-type-menu-item-'.$post_type.$menu_id.'" id="link-type-menu-item-'.$post_type.$menu_id.'">';
			...
			<li id="add-app-menus" class="control-section accordion-section   add-app-menus">
							...
							<ul class="categorychecklist form-no-clear" id="app-checklist-all">
                                ...
                                */
                                ...
                                foreach ($this->appmenus_pre as $appmenu_pre) {
                                    ...
                                    if (isset($appmenu_pre['extrafields'])) {
                                        echo '<input type="hidden" value=\''.json_encode($appmenu_pre['extrafields']).'\' name="extrafield-menu-item-'.$appmenu_pre['type'].$menu_id.'" id="extrafield-menu-item-'.$appmenu_pre['type'].$menu_id.'">';
                                    }
                                ...
                                do_action('nh_add_app_extras_menu');
                                    //wp_category_checklist();
				...
				<?php do_action('nh_add_accordion_menu'); ?>
		</ul><!-- .outer-border -->
		...
		<div id="menu-management">
			<div class="menu-edit ">
				<div id="nav-menu-header">
                  ...
                  <?php if (count($this->menu_settings['menu']) >= 1) {
                                    echo '<a href="#" id="delete-all" class="item-delete-all">Delete all</a>';
                                }
											...
											<li class="menu-item menu-item-depth-0 menu-item-<?php echo $menuitem['type']; ?> menu-item-edit-inactive pending" id="menu-item-<?php echo $menuitem['pos']; ?>" style="display: list-item;">
												...
												<div id="menu-item-settings-<?php echo $menuitem['pos']; ?>" class="menu-item-settings">
													<p class="description description-thin">
														<label for="edit-menu-item-title-<?php echo $menuitem['pos']; ?>"><?php _e('Label', 'nh-ynaa'); ?></label><br>
                                                    ...
                                                    if (isset($this->appmenus_pre[$menuitem['item_id']]['extrafields'])) {
                                                        foreach ($this->appmenus_pre[$menuitem['item_id']]['extrafields'] as $k2=>$extrafield) {
                                                            ?>
															<div style="clear:left; margin-top:10px;"><p><label
																		for="edit-menu-item-<?php echo $k2; ?>-<?php echo $menuitem['pos']; ?>"><?php echo $extrafield['label']; ?><br><input
																			type="<?php echo $extrafield['type']; ?>"
																			value="<?php echo $menuitem[$k2]; ?>"
																			name="<?php echo $this->menu_settings_key; ?>[menu][<?php echo $k; ?>][<?php echo $k2; ?>]"
																			class="widefat edit-menu-item-url"
																			id="edit-menu-item-<?php echo $k2; ?>-<?php echo $menuitem['pos']; ?>">
																</p></div>
															<?php

                                                        }
                                                    }
                                            if (isset($menuitem['customfilter'])) {
                                                echo '<input type="hidden" value="'.$menuitem['customfilter'].'" name="'.$this->menu_settings_key.'[menu]['.$k.'][customfilter]" id="'.$this->menu_settings_key.'_menu_'.$k.'_customfilter">';
                                            } ?>
